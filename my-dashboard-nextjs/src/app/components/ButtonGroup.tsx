...
export const ButtonGroup: React.FC<ButtonGroupProps> = ({ selectedPeriod, onPeriodChange }) => {
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex rounded-lg bg-[#F7F7F7]">
        {periods.map((period) => (
          <button
            key={period}
      ...
      <div className="flex gap-3">
        <button className="px-[14px] py-[10px] text-[14px] border border-[#D0D5DD] rounded-lg bg-white text-[#344054] flex items-center gap-2">
        ...
        <button className="px-[14px] py-[10px] text-[14px] border border-[#D0D5DD] rounded-lg bg-black text-white flex items-center gap-2">
