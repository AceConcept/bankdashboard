  ...
  return (
    <header className="p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between sm:gap-4">
        <h1 className="text-2xl sm:text-[18px] font-semibold">
          <span className="sm:hidden">Welcome back, William Blake</span>
          <span className="hidden sm:inline">Dashboard</span>
        </h1>
        
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
          {/* Search Bar - Hidden on mobile and tablet */}
          <div className="hidden lg:flex relative w-[249px] h-[36px] items-center border border-[#D0D5DD] rounded-lg px-3 bg-white">
          ...
          {/* Action Icons - Hidden on mobile and tablet */}
          ...
          {/* Team Members & Invite - Only visible on desktop */}
          <div className="hidden lg:flex items-center gap-4">
            ...
            <button className="h-9 px-4 flex items-center justify-center gap-2 bg-white text-sm border border-[#D0D5DD] rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                <path d="M0.75 13.9999C0.749953 14.4141 1.0857 14.75 1.49992 14.75C1.91413 14.75 2.24995 14.4143 2.25 14.0001L0.75 13.9999ZM1.50025 11.7497L2.25025 11.7498L1.50025 11.7497ZM7.875 10.25C8.28921 10.25 8.625 9.91421 8.625 9.5C8.625 9.08579 8.28921 8.75 7.875 8.75V10.25ZM13.5 11C13.9142 11 14.25 10.6642 14.25 10.25C14.25 9.83578 13.9142 9.5 13.5 9.5V11ZM10.125 9.5C9.71078 9.5 9.375 9.83578 9.375 10.25C9.375 10.6642 9.71078 11 10.125 11V9.5ZM11.0625 11.9374C11.0625 12.3516 11.3983 12.6874 11.8125 12.6874C12.2267 12.6874 12.5625 12.3516 12.5625 11.9374H11.0625ZM12.5625 8.56241C12.5625 8.1482 12.2267 7.81241 11.8125 7.81241C11.3983 7.81241 11.0625 8.1482 11.0625 8.56241H12.5625ZM8.25 4.25C8.25 5.07843 7.57843 5.75 6.75 5.75V7.25C8.40685 7.25 9.75 5.90685 9.75 4.25H8.25ZM6.75 5.75C5.92157 5.75 5.25 5.07843 5.25 4.25H3.75C3.75 5.90685 5.09314 7.25 6.75 7.25V5.75ZM5.25 4.25C5.25 3.42157 5.92157 2.75 6.75 2.75V1.25C5.09314 1.25 3.75 2.59315 3.75 4.25H5.25ZM6.75 2.75C7.57843 2.75 8.25 3.42157 8.25 4.25H9.75C9.75 2.59315 8.40685 1.25 6.75 1.25V2.75Z" fill="#1D1C20"/>
              </svg>
              Invite
            </button>
          </div>
